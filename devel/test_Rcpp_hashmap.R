...
starttime=proc.time()
painting=paintingalldense(gd,refindex,1000,fixrho=FALSE,method="Viterbi",minmatchfrac = 0.0001,L=80)
proc.time()-starttime

painting=paintingalldense(gd,refindex,50,fixrho=TRUE,indfrac=0.001,minmatchfrac = 0.0001,L=80)
painting=paintingalldense(gd,refindex,50,ite_time=10,method="EM",
                          indfrac=0.001,minmatchfrac = 0.0001,L=80)
painting=paintingalldense(gd,refindex,50,ite_time=10,method="EM",
